...
export class ClassComponent extends Component {
    /*  장문주석키 alt + shift + A
        ...
        - React Hook이 등장하면서 해당 기능들도 Fynction 컴포넌트에서 사용이 가능!
   ...
   //    : 사용자들은 조금이라도 화면이 먼저 뜨면 '빠르다'고 느낌
   //    : 그렇기 때문에 무거운 데이터들을 일부러라도 화면을 띄운 후에 가져온다!
   componentDidMount(){
   ...
   //    : 컴포넌트가 제거되기 직전에 실행
   //    : 타이머, 이벤트 리스너, 네크워크 연결 종료 등 정리(cleanup)할 때 사용
